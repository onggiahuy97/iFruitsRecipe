...
class ViewModel: ObservableObject {
    ...
    enum FoodType: String, CaseIterable {
        ...
        var prompt: String {
            switch self {
            case .smoothie: return "Give me a smoothie recipe with these ingredients: "
            case .food: return "Give me a recipe with these ingredients: "
            }
        }
    }
    ...
    func generateRecipe() async {
        ...
        let prompt = "\(self.foodType.prompt) \(ingredients) \n and give me the answer in format of title of the recipe, and then step by step on how to make the recipe"
